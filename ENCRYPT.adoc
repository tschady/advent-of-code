...
NOTE: all paths and globs are written for my specific needs, you will need to update them for yours.  My old problematic inputs were in path `resources/2015/d01.txt` and my new ones are `resources/inputs/2015/d01.txt`
